...
SCRIPT ToggleSwitchRegular 
	...
	IF GotParam PowerSlide 
		...
		ELSE 
			IF RightPressed 
				IF Flipped 
					PlayAnim Anim = BSPowerslide BlendPeriodOut 0.40000000000
				ELSE 
					PlayAnim Anim = FSPowerslide BlendPeriodOut 0.40000000000
				ENDIF 
			ELSE 
				PlayAnim Anim = FSPowerslide BlendPeriodOut 0.40000000000
			ENDIF 
	...
	ELSE 
		IF LeftPressed 
			IF Flipped 
				IF NOT crouched 
					PlayAnim RANDOM(1, 1) RANDOMCASE Anim = CessSlide180_FS RANDOMCASE Anim = CessSlide180_FS2 RANDOMEND BlendPeriodOut 0.40000000000
				ELSE 
					PlayAnim Anim = CrouchCessSlide180_FS BlendPeriodOut 0.40000000000 
				ENDIF 
			ELSE 
				IF NOT crouched 
					PlayAnim Anim = CessSlide180_BS  BlendPeriodOut 0.40000000000
				ELSE 
					PlayAnim Anim = CrouchCessSlide180_BS  BlendPeriodOut 0.40000000000
				ENDIF 
			ENDIF 
		ELSE 
			IF RightPressed 
	...
	IF NOT GotParam PowerSlide 
		IF CanKick 
			PlayAnim Anim = PushCycle Cycle BlendPeriod = 0.40000000000 BlendPeriodOut 0.40000000000
		ELSE 
			IF AnimFinished 
				IF NOT crouched 
					PlayAnim Anim = Idle Cycle BlendPeriod = 0.40000000000 BlendPeriodOut 0.40000000000
				ELSE 
					IF NOT AnimEquals [ CrouchCessSlide180_FS CrouchCessSlide180_BS ] 
						PlayAnim Anim = Idle Cycle BlendPeriod = 0.00000000000 BlendPeriodOut 0.40000000000
						PlayAnim Anim = CrouchIdle Cycle BlendPeriod = 0.20000000298 BlendPeriodOut 0.40000000000
					ELSE 
						PlayAnim Anim = CrouchIdle Cycle BlendPeriod = 0.00000000000 BlendPeriodOut 0.40000000000
					ENDIF 
				ENDIF 
			ENDIF 
		ENDIF 
...
SCRIPT ToggleNollieRegular 
	...
	IF NOT InNollie 
		IF NOT InPressure 
			...
			ENDIF 
			IF crouched 
				PlayAnim Anim = CrouchToNollie BlendPeriod = 0.10000000149 Backwards BlendPeriodOut 0.40000000000
			ELSE 
				PlayAnim Anim = SkatingToNollie BlendPeriod = 0.10000000149 Backwards BlendPeriodOut 0.40000000000
			ENDIF 
		ELSE 
			IF NOT GoalManager_GoalShouldExpire 
				SetException Ex = Ollied Scr = Ollie 
			ENDIF 
			IF crouched 
				PlayAnim Anim = CrouchToPressure BlendPeriod = 0.10000000149 BlendPeriodOut 0.40000000000
			ELSE 
				PlayAnim Anim = SkateToPressure BlendPeriod = 0.10000000149 BlendPeriodOut 0.40000000000
			ENDIF 
		ENDIF 
	ELSE 
		IF NOT GoalManager_GoalShouldExpire 
		...
		ENDIF 
		IF crouched 
			PlayAnim Anim = CrouchToNollie BlendPeriod = 0.10000000149 BlendPeriodOut 0.40000000000
		ELSE 
			PlayAnim Anim = SkatingToNollie BlendPeriod = 0.10000000149 BlendPeriodOut 0.40000000000
		ENDIF 
	ENDIF 
	WaitAnimWhilstChecking AndManuals 
	IF InNollie 
...
SCRIPT Nollie 
	...
	NollieOn 
	PlayAnim Anim = Nollie BlendPeriod = 0.00000000149 
